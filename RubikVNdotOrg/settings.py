"""
Django settings for RubikVNdotOrg project.
...
ROOT_URLCONF = 'RubikVNdotOrg.urls'
...
WSGI_APPLICATION = 'RubikVNdotOrg.wsgi.application'
...
STATIC_ROOT = os.path.join(os.getcwd(), "static-collected")
